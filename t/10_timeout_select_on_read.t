...
subtest "should die if wait more than out_timeout with a timeout provider based on SelectOnRead" => sub {
  plan tests => 2;
...
subtest "should not die with a timeout provider based on SelectOnRead" => sub {
  plan tests => 1;
